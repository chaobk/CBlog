...
public class BlogServiceImpl implements BlogService {
    ...
    @Override
    public List<com.chaobk.entity.Blog> getListByTitleAndCategoryId(String title, Integer categoryId) {
    ...
    public void updateBlogRecommendById(Long blogId, Boolean recommend) {
        com.chaobk.entity.Blog blog = com.chaobk.entity.Blog.builder().id(blogId).recommend(recommend).build();
    ...
    public void updateBlogTopById(Long blogId, Boolean top) {
        com.chaobk.entity.Blog blog = com.chaobk.entity.Blog.builder().id(blogId).top(top).build();
        if (blogMapper.updateById(blog) != 1) {
            throw new PersistenceException("操作失败");
        }
        redisService.deleteCacheByKey(RedisKeyConstants.HOME_BLOG_INFO_LIST);
    ...
    @Override
    public com.chaobk.entity.Blog getBlogById(Long id) {
        com.chaobk.entity.Blog blog = blogMapper.getBlogById(id);
        if (blog == null) {
